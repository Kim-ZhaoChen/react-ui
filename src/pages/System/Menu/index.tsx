...
const MenuTableList: React.FC = () => {
  ...
  const columns: ProColumns<API.System.Menu>[] = [  
    {
      title: <FormattedMessage id="system.menu.menu_name" defaultMessage="Menu Name" />,
      dataIndex: 'menuName',
      valueType: 'text',
    },
    {
      title: <FormattedMessage id="system.menu.icon" defaultMessage="Menu Icon" />,
      dataIndex: 'icon',
      valueType: 'text',
      hideInSearch: true,
    },
    {
      title: <FormattedMessage id="system.menu.order_num" defaultMessage="Order" />,
      dataIndex: 'orderNum',
      valueType: 'text',
      hideInSearch: true,
    },
    {
      title: <FormattedMessage id="system.menu.component" defaultMessage="Path" />,
      dataIndex: 'component',
      valueType: 'text',
      hideInSearch: true,
    },
    {
      title: <FormattedMessage id="system.menu.perms" defaultMessage="Permissions" />,
      dataIndex: 'perms',
      valueType: 'text',
      hideInSearch: true,
    },
    {
      title: <FormattedMessage id="system.menu.status" defaultMessage="Menu Status" />,
      dataIndex: 'status',
      valueType: 'select',
        ...
        <ProTable<API.System.Menu>
          ...
          request={(params) =>
            getMenuList({ ...params } as API.System.MenuListParams).then((res) => {
              const rootMenu = { id: 0, label: 'Main category', children: [] as DataNode[], value: 0 };
