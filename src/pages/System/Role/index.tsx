...
const RoleTableList: React.FC = () => {
  ...
  const showChangeStatusConfirm = (record: API.System.Role) => {
    ...
    confirm({
      title: `Confirm要${text}${record.roleName}角色吗？`,
      onOk() {
  ...
  const columns: ProColumns<API.System.Role>[] = [
    {
      title: <FormattedMessage id="system.role.role_id" defaultMessage="Role Code" />,
      dataIndex: 'roleId',
      valueType: 'text',
    },
    {
      title: <FormattedMessage id="system.role.role_name" defaultMessage="Role Name" />,
      dataIndex: 'roleName',
      valueType: 'text',
    },
    {
      title: <FormattedMessage id="system.role.role_key" defaultMessage="Role permission string" />,
      dataIndex: 'roleKey',
      valueType: 'text',
      hideInSearch: true,
    },
    {
      title: <FormattedMessage id="system.role.role_sort" defaultMessage="Order" />,
      dataIndex: 'roleSort',
      valueType: 'text',
      hideInSearch: true,
    },
    {
      title: <FormattedMessage id="system.role.status" defaultMessage="Role Status" />,
      dataIndex: 'status',
      valueType: 'select',
    ...
    {
      title: <FormattedMessage id="system.role.create_time" defaultMessage="Create Time" />,
