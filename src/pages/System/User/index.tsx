...
const UserTableList: React.FC = () => {
  ...
  const showChangeStatusConfirm = (record: API.System.User) => {
    ...
    confirm({
      title: `Confirm要${text}${record.userName}用户吗？`,
      onOk() {
  ...
  const columns: ProColumns<API.System.User>[] = [
    {
      title: <FormattedMessage id="system.user.user_id" defaultMessage="userid" />,
      dataIndex: 'deptId',
      valueType: 'text',
    },
    {
      title: <FormattedMessage id="system.user.user_name" defaultMessage="userName" />,
      dataIndex: 'userName',
      valueType: 'text',
    },
    {
      title: <FormattedMessage id="system.user.nick_name" defaultMessage="nickName" />,
      dataIndex: 'nickName',
      valueType: 'text',
    },
    {
      title: <FormattedMessage id="system.user.dept_name" defaultMessage="deptName" />,
      dataIndex: ['dept', 'deptName'],
      valueType: 'text',
      hideInSearch: true
    },
    {
      title: <FormattedMessage id="system.user.phonenumber" defaultMessage="phonenumber" />,
      dataIndex: 'phonenumber',
      valueType: 'text',
    },
    {
      title: <FormattedMessage id="system.user.status" defaultMessage="status" />,
      dataIndex: 'status',
      valueType: 'select',
    ...
    {
      title: <FormattedMessage id="pages.searchTable.titleOption" defaultMessage="operate" />,
      dataIndex: 'option',
      width: '220px',
      valueType: 'option',
      render: (_, record) => [
        ...
        <Dropdown
          ...
          menu={{
            items: [
              {
                label: <FormattedMessage id="system.user.reset.password" defaultMessage="ResetPassword" />,
                key: 'reset',
