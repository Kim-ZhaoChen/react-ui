...
const DeptTableList: React.FC = () => {
  ...
  const columns: ProColumns<API.System.Dept>[] = [
    {
      title: <FormattedMessage id="system.dept.dept_name" defaultMessage="Dept Name" />,
      dataIndex: 'deptName',
      valueType: 'text',
    },
    {
      title: <FormattedMessage id="system.dept.order_num" defaultMessage="Order" />,
      dataIndex: 'orderNum',
      valueType: 'text',
    },
    {
      title: <FormattedMessage id="system.dept.status" defaultMessage="Dept Status" />,
      dataIndex: 'status',
      valueType: 'select',
          ...
          onClick={() => {
            getDeptListExcludeChild(record.deptId).then((res) => {
              if (res.code === 200) {
                ...
                if(depts.length === 0) {
                  depts = [{ id: 0, title: 'No superiors', children: undefined, key: 0, value: 0 }];
                }
                setDeptTree(depts);
